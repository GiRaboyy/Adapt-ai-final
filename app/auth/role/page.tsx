...
export default function RoleSelectionPage() {
  ...
  return (
    <AuthLayout showMenu={false} maxWidth="max-w-xl">
      <div className="glass-card rounded-2xl shadow-xl px-8 py-10">
        ...
        {/* Error */}
        {error && (
          <div className="bg-[#FFF1F2] border-2 border-[#FCA5A5] rounded-xl p-4 flex items-start gap-3 mb-6">
            ...
            <p className="text-sm font-medium text-[#111827] flex-1">{error}</p>
          </div>
        )}
